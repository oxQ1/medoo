...
def stream_markup_timer(_, chat_id, played, dur):
    ...
    buttons = [
            ...
            InlineKeyboardButton(text="𝐑𝐞𝐬𝐮𝐦𝐞", callback_data=f"ADMIN Resume|{chat_id}"),
            InlineKeyboardButton(text="𝐏𝐚𝐮𝐬𝐞", callback_data=f"ADMIN Pause|{chat_id}"),
            
        ],[
            InlineKeyboardButton(text="𝐒𝐨𝐮𝐫𝐜𝐞", url=f"https://t.me/UJ_5Q"),
            InlineKeyboardButton(text="𝐆𝐫𝐨𝐮𝐩", url=f"https://t.me/U7_4K"),
        ],[
            InlineKeyboardButton(text="𝐌𝐄𝐃𝐎", url=f"https://t.me/ox_Q1"),
        ],[
