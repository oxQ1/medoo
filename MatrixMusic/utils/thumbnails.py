...
async def get_thumb(videoid):
    ...
    arial = ImageFont.truetype("MatrixMusic/assets/assets/font2.ttf", 30)
    font = ImageFont.truetype("MatrixMusic/assets/assets/font2.ttf", 30)
    title_font = ImageFont.truetype("MatrixMusic/assets/assets/font2.ttf", 45)
    ...
    play_icons = Image.open("MatrixMusic/assets/assets/play_icons.png")
